...
function InstagramIcon({ className = "w-3.5 h-3.5 text-[#E8BD44]" }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" width="14" height="14" style={{ width: "1.25em", height: "1.25em", maxWidth: "100%" }} className={`fill-current ${className}`} xmlns="http://www.w3.org/2000/svg">
